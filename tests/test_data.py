...
@pytest.mark.parametrize('json_path', [
    ...
    '../examples/workshop/modelling-bods-data/egg-trust-ernesto-gomez-garrido.json',
    '../examples/workshop/modelling-bods-data/egg-trust.json',
    '../examples/workshop/modelling-bods-data/ernesto-gomez-garrido.json',
